@extends('resources.views.dashboard.gentelella.layouts.app')
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    {{ __('Editar o lead', ['title' => $lead->id]) }} 
                    <small>{{ __('Ao criar um template ela sera vinculado ao plano escolhido.') }}</small>
                </h2>
            ...
            <div class="x_content">
                <br />
                {!! Form::model($lead, ['route' => ['admin.leads.update', $lead->id], 'method' => 'put', 'class' => 'form-horizontal form-label-left']) !!}
