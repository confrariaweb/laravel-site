...
@section('title', __('Tipos de páginas'))
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    {{ __('Criar um novo tipo de página') }} 
                    <small>{{ __('Ao criar um tipo de página ele será vinculado a conta.') }}</small></h2>
                @include('dashboard.gentelella.page-types.partials.panel_toolbox')
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                {!! Form::open(['route' => ['admin.page-types.store'], 'method' => 'post', 'class' => 'form-horizontal form-label-left']) !!}
