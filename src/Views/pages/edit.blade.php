...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    {{ __('Editar a página ' . $page->title .  ' de ' . $page_type->title) }} 
                    <small>{{ __('Ao criar uma pagina ela sera vinculado ao plano escolhido.') }}</small>
                </h2>
                @include('dashboard.gentelella.pages.partials.panel_toolbox')
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                {!! Form::model($page, ['route' => ['admin.pages.update', $page->id], 'files' => true, 'method' => 'put', 'class' => 'form-horizontal form-label-left']) !!}
